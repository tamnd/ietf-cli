...
// HTTP behaviour is covered in ietf_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "ietf://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ietf", "about")
	if err != nil || got.String() != "ietf://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ietf://page/about", got.String(), err)
	}
}
