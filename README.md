...
Or grab a prebuilt binary from the [releases](https://github.com/tamnd/ietf-cli/releases), or run
the container image:
...
ietf --help                           # the whole command tree
```
...
ietf mcp                   # speak MCP over stdio
```

## Use it as a resource-URI driver

`ietf` registers a `ietf` domain the way a program registers a
...
```
cmd/ietf/   thin main: hands cli.NewApp to kit.Run
